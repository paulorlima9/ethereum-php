...
class Block extends EthDataType
{
    ...
    public function toArray()
    {
        ...
        (! is_null($this->transactions)) ? $return['transactions'] = Ethereum::valueArray($this->transactions, 'Transaction') : [];
        (! is_null($this->uncles)) ? $return['uncles'] = Ethereum::valueArray($this->uncles, 'EthD') : [];
